...
import { b as useRuntimeConfig$1 } from '../nitro/node-server.mjs';
import 'stream';
...
const ___packages_nuxt_src_head_runtime_lib_vueuse_head_plugin_ts_IobhkJHvHV = defineNuxtPlugin((nuxtApp) => {
...
const ___packages_nuxt_src_head_runtime_plugin_ts_Bv6qkOsY76 = defineNuxtPlugin((nuxtApp) => {
...
const ___packages_nuxt_src_app_plugins_router_ts_h9ghz9Ez0V = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  ___packages_nuxt_src_head_runtime_lib_vueuse_head_plugin_ts_IobhkJHvHV,
  ___packages_nuxt_src_head_runtime_plugin_ts_Bv6qkOsY76,
  ___packages_nuxt_src_app_plugins_router_ts_h9ghz9Ez0V
];
const _sfc_main$1 = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./_nuxt/error-component.f83445ec.mjs'));
    const nuxtApp = useNuxtApp();
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../packages/nuxt/src/app/components/nuxt-root.vue");
...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: resDataSuccess } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch(
      "/api/test",
      {
        method: "post",
        body: {
    ...
    const { data: resData } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("/api/test", "$yOWuy93Eps")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div>Post state: ${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(resDataSuccess))}</div><div>Get Data: ${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(resData).text)}</div></div>`);
    };
  }
});

...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.30fc27bf.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.17797a1f.mjs'));
...
//# sourceMappingURL=error-component.f83445ec.mjs.map

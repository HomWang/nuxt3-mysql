...
import { a as useNitroApp, b as useRuntimeConfig } from '../nitro/node-server.mjs';
...
const renderer = defineRenderHandler(async (event) => {
  ...
  if (((_b = ssrContext.payload) == null ? void 0 : _b.error) && !ssrError) {
    throw ssrContext.payload.error;
  }
  const renderedMeta = (_d = await ((_c = ssrContext.renderMeta) == null ? void 0 : _c.call(ssrContext))) != null ? _d : {};
  const rendered = {
    ssrContext,
    html: {
      ...
      bodyPreprend: normalizeChunks([
        ...
        (_e = ssrContext.teleports) == null ? void 0 : _e.body
      ]),
      body: [
        _rendered.html
      ],
  ...
  const nitroApp = useNitroApp();
  await ((_f = ssrContext.nuxt) == null ? void 0 : _f.hooks.callHook("app:rendered", rendered));
